...
export default function PrivacyPolicy({ privacypolicy, setprivacypolicy }) {
  return (
    <>
      <Modal
        className={"privacypolicy_container"}
        overlayClassName="privacypolicy_modal_Overlay"
      ...
      >
        <div className="privacypolicy_box">
          <div className="privacypolicy_header">
            <div className="privacypolicy_title">Privacy Policy</div>

            <button
              className="privacypolicy_close_btn"
              onClick={(e) => {
                e.preventDefault();
                setprivacypolicy(false);
              }}
          ...
          <div className="privacypolicy_content">
            <span className="privacypolicy_content_headings">
              Privacy Policy
            </span>
            <br />
            <br />
      ...
      {privacypolicy && <div className="blurEffect"></div>}
    </>
  );
}
