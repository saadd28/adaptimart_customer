...
export default function RefundPolicy({ refundpolicy, setrefundpolicy }) {
  return (
    <>
      <Modal
        className={"refundpolicy_container"}
        overlayClassName="refundpolicy_modal_Overlay"
      ...
      >
        <div className="refundpolicy_box">
          <div className="refundpolicy_header">
            <div className="refundpolicy_title">Refund Policy</div>

            <button
              className="refundpolicy_close_btn"
              onClick={(e) => {
                e.preventDefault();
                setrefundpolicy(false);
              }}
          ...
          <div className="refundpolicy_content">
            <span className="refundpolicy_content_headings">
              Refund Policy
            </span>
            <br />
            <br />
      ...
      {refundpolicy && <div className="blurEffect"></div>}
    </>
  );
}
