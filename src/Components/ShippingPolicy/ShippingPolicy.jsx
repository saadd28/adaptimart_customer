...
export default function ShippingPolicy({ shippingpolicy, setshippingpolicy }) {
  return (
    <>
      <Modal
        className={"shippingpolicy_container"}
        overlayClassName="shippingpolicy_modal_Overlay"
        onAfterOpen={disableScrollOnOpen}
        onAfterClose={disableScrollOnClose}
        isOpen={shippingpolicy}
        shouldCloseOnOverlayClick={true}
        onRequestClose={() => {
          setshippingpolicy(false);
          console.log("shippingpolicy", shippingpolicy);
        }}
        shouldCloseOnEsc={true}
      >
        <div className="shippingpolicy_box">
          <div className="shippingpolicy_header">
            <div className="shippingpolicy_title">Shipping Policy</div>

            <button
              className="shippingpolicy_close_btn"
              onClick={(e) => {
                e.preventDefault();
                setshippingpolicy(false);
              }}
          ...
          <div className="shippingpolicy_content">
            <span className="shippingpolicy_content_headings">
              Shipping Policy
            </span>
            <br />
            <br />
      ...
      {shippingpolicy && <div className="blurEffect"></div>}
    </>
  );
}
