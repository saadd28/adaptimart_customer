      ...
      <div className="edit_profile_box">
        ...
        <div className="edit_profile_container">
          ...
          <div className="edit_profile_btn_container">
            <button className="edit_profile_btn edit_profile_cancel_btn">Cancel</button>
            <button className="edit_profile_btn edit_profile_update_btn">Update Profile</button>
          </div>
        </div>
      </div>
    </>
